...
async function cleanCase2TestOrders() {
  console.log('🧹 Bắt đầu dọn dẹp các đơn hàng test Case 2...');
...
cleanCase2TestOrders()
  .catch((e) => {
    console.error('❌ Lỗi khi dọn dẹp đơn hàng Case 2:', e);
  })
  .finally(async () => {
