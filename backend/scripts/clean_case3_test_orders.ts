...
async function cleanCase3TestOrders() {
  console.log('🧹 Bắt đầu dọn dẹp các đơn hàng test Case 3...');
...
cleanCase3TestOrders()
  .catch((e) => {
    console.error('❌ Lỗi khi dọn dẹp đơn hàng Case 3:', e);
  })
  .finally(async () => {
