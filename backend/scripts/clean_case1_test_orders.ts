...
async function cleanCase1TestOrders() {
  console.log('🧹 Bắt đầu dọn dẹp các đơn hàng test Case 1...');
...
cleanCase1TestOrders()
  .catch((e) => {
    console.error('❌ Lỗi khi dọn dẹp đơn hàng Case 1:', e);
    process.exit(1);
  })
  .finally(async () => {
